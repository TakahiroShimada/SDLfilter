...
Overview 
--------
SDLfilter contains a variety of functions to screen GPS/Argos locations and to assess the sample size of tracking data to optimise the analysis of animal distributions. 
...
```{r, message=FALSE, echo=FALSE}
 # Entire area
 p1<-track_map(turtle.dup, bgmap=Australia, point.size = 2, line.size = 0.5, axes.lab.size = 0, 
 ...
 # Zoomed in
 p2<-track_map(turtle.dup, bgmap=SandyStrait, xlim=c(152.7, 153.2), ylim=(c(-25.75, -25.24)), 
...
> Please see the package help pages and Shimada et al. (2012, 2016, in press) for more details.
...
Shimada T, Thums M, Hamann M, Limpus CJ, Hays GC, FitzSimmons N, Wildermann NE, Duarte CD, Meekan MG (in press) Optimising sample sizes for animal distribution analysis using tracking data. Methods in Ecology and Evolution, n/a(n/a). doi:10.1111/2041-210X.13506
