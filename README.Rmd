...
It will take some time to run this code depending on the number of iterations and the machine specs. The runtime was about 2.5 minutes for 1500 iterations on a linux machine (Intel i7-4702HQ CPU @ 2.20GHz, 16GB RAM).
```{r results=FALSE}
...
If you use the functions *asymptote*, *boot_overlap* or *boot_area*, please cite
