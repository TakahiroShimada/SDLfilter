...
Overview 
--------
SDLfilter contains a variety of functions to screen GPS/Argos locations and to assess the sample size of tracking data for the analysis of animal distributions. 
...
Shimada T,.... (under review) Assessing the sample size of tracking tag deployments for animal distribution analysis. 


Current version
--------
2.0.0.9003 (21 June 2020)
