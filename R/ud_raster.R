...
#' instead of 50m as used in \href{http://doi.org/10.1111/2041-210X.13506}{Shimada et al. (2021)}.
#' See \href{https://github.com/TakahiroShimada/SDLfilter} for an example code of UD estimation.
#' @format A list of 15 RasterLayer objects
